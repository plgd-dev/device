...
type DiscoveryClient struct {
	...
	server    *udp.Server
	wg        sync.WaitGroup
	opts      []udp.MulticastOption
}

func newDiscoveryClient(network, mcastaddr string, msgID uint16, timeout time.Duration, errors func(error), opts []udp.MulticastOption) (*DiscoveryClient, error) {
